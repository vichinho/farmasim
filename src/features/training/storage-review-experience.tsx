...
import { DUA_HINT_LIMIT, duaHintsForCase } from "@/features/training/dua-guidance";
      ...
      <div className="grid lg:grid-cols-[minmax(0,1.15fr)_minmax(20rem,.85fr)]">
        ...
        <aside className="bg-[var(--simulation-panel)] p-4 sm:p-5">
          {stage === "intro" ? (
            ...
            <StorageResult hintsUsed={duaHintsUsed} persistence={persistence} review={review} scenario={scenario} onSave={saveReview} />
...
function StorageResult({ hintsUsed, onSave, persistence, review, scenario }: { hintsUsed: number; onSave: () => void; persistence: PersistenceState; review: Record<string, ReviewEntry>; scenario: ScenarioDefinition }) {
  return (
    <section>
      ...
      <div className="mt-5"><DuaResultCard hintsUsed={hintsUsed} /></div>
